...
import org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.toaster.rev091120.toaster.ChildtoasterBuilder;
...
public class OpendaylightToaster implements ToasterService, ToasterProviderRuntimeMXBean,
    ...
    private static final DisplayString TOASTER_MAKER = new DisplayString("ChildOpendaylight");
    private static final DisplayString TOASTER_MODEL = new DisplayString("ChildModel 1 - Binding Aware");
    ...
    private Toaster buildToaster( final ToasterStatus status ) {
        ...
        return new ToasterBuilder().setToasterManufacturer( TOASTER_MANUFACTURER )
                                   ...
                                   .setChildtoaster(new ChildtoasterBuilder().setToasterMaker(TOASTER_MAKER).setToasterModel(TOASTER_MODEL).build())
                                   .build();
    }
